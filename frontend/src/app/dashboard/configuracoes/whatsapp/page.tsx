...
import { MessageCircle, Wifi, WifiOff, QrCode, Trash2, RefreshCw,
         CheckCircle, Save, ToggleLeft, ToggleRight, Bot, Eye } from "lucide-react";
...
export default function WhatsappPage() {
  ...
  const salvarConfig = async () => {
    setSalvando(true);
    try { await api.patch("/whatsapp/configuracoes", config); toast.sucesso("Configurações salvas!"); }
  ...
  const salvarEmpresa = async () => {
    setSalvando(true);
    try { await api.patch("/conta/empresa", empresa); toast.sucesso("Negócio atualizado!"); }
    catch { toast.erro("Erro ao salvar"); }
    finally { setSalvando(false); }
  };
          ...
          {aba === "atendimento" && config && (
            <div className="space-y-4">
              ...
              <div className="rounded-xl p-5" style={{ background:SURF, border:`1px solid ${BORD}` }}>
                ...
                <p className="text-xs mb-3" style={{ color:"#6b7280" }}>Ex: "Não informe preços sem confirmar o estoque."</p>
              ...
              <div className="rounded-xl p-5" style={{ background:SURF, border:`1px solid ${BORD}` }}>
                ...
                {preview && (
                  <div className="rounded-lg p-3 text-xs" style={{ background:BG, border:`1px solid ${BORD}`, color:"#d1d5db" }}>
                    <div className="flex items-center gap-2 mb-2">
                      <Bot size={14} style={{ color:"#f97316" }}/><span className="font-medium" style={{ color:"#f97316" }}>Orbita responderia:</span>
                    </div>
          ...
          {aba === "negocio" && empresa && (
            <div className="space-y-4">
              <div className="rounded-xl p-4 text-sm" style={{ background:"rgba(249,115,22,0.06)", border:"1px solid rgba(249,115,22,0.2)", color:"#f97316" }}>
                ...
                A Orbita usa essas informações para se adaptar ao seu tipo de negócio.
              </div>
              ...
              <div className="rounded-xl p-5" style={{ background:SURF, border:`1px solid ${BORD}` }}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs mb-1" style={{ color:"#9ca3af" }}>Horário</label>
                    ...
                    <div>
                      <label className="block text-xs mb-1" style={{ color:"#9ca3af" }}>Pagamento</label>
